...
df_a1_grouped['case_fatality_rate'] = df_a1_grouped['total_deaths'] / df_a1_grouped['total_cases']
...
# make all 0 into NaN for data integrity, and remove rows 
# if there are no entries at all for that location in that month
df_a1_final.replace(0, np.nan, inplace = True)
df_a1_final.dropna(how = "all", inplace = True)
